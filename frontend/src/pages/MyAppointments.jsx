            ...
            <div className=''>
                {appointments.map((item, index) => (
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        <div>
                            <img className='w-36 bg-[#EAEFFF]' src={item?.SelData?.image} alt="" />
                        </div>
                        <div className='flex-1 text-sm text-[#5E5E5E]'>
                            <p className='text-[#262626] text-base font-semibold'>{item?.SelData?.name}</p>
                            <p>{item?.SelData?.speciality}</p>
                            <p className='text-[#464646] font-medium mt-1'>Address:</p>
                            <p className=''>{item.SelData.address.line1}</p>
                            <p className=''>{item.SelData.address.line2}</p>
                        ...
                        <div className='flex flex-col justify-end gap-2 text-sm text-center'>
                            ...
                            {!item.cancelled && item.payment && !item.isCompleted && <button className='sm:min-w-48 py-2 border rounded text-[#696969]  bg-[#0fdf69]'>Paid</button>}
